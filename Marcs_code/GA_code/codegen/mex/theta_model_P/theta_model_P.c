...
static emlrtRTEInfo k_emlrtRTEI = { 62,/* lineNo */
  9,                                   /* colNo */
  "theta_model_P",                     /* fName */
  "C:\\Users\\Luke\\Documents\\Computer Science\\Year 4\\Group Project\\EpilepsyGroupProject\\Marcs_code\\GA_code\\theta_model_P.m"/* pName */
};

static emlrtRTEInfo l_emlrtRTEI = { 73,/* lineNo */
  23,                                  /* colNo */
  "theta_model_P",                     /* fName */
  "C:\\Users\\Luke\\Documents\\Computer Science\\Year 4\\Group Project\\EpilepsyGroupProject\\Marcs_code\\GA_code\\theta_model_P.m"/* pName */
};
                     ...
                     real_T nodes_resected)
{
  ...
  for (idx = 0; idx < 3999999; idx++) {
    ...
    for (k = 0; k < nx; k++) {
      s_data[k] = muDoubleScalarCos(s_data[k]);
    }

    for (i = 0; i < nx; i++) {
      s_data[i] = 0.5 * (1.0 - s_data[i]);
    }
    ...
    if (0 <= nx - 1) {
      memcpy(&signal_data[0], &s_data[0], nx * sizeof(real_T));
    }
